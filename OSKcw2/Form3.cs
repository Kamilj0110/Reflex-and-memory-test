    ...
    public partial class Form3 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            if (koniecTestu2)
            {
                ...
                {
                    this.oknoGlowne.button2.Enabled = false;
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (!klik)
                    {
                        ...
                        {
                            this.oknoGlowne.czasReakcji2[liczbaWykonanychTestow] = elapsedMilliseconds;
                            liczbaWykonanychTestow++;
                        }

                        if (liczbaWykonanychTestow == 3 && !koniecTestu2)
                        {
